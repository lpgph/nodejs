...
async function main() {
  ...
  try {
    ...
    await page.goto('https://paipai.jd.com/auction-list/{"pageNo":1,"pageSize":50,"category1":"","status":"","orderDirection":1,"orderType":1,"groupId":1000006}?entryid=')
    ...
    const handleDate = async () => {
      ...
      if (list != null && list.length > 0) {
        const result = await mongo.insertMany('mobile', list)
